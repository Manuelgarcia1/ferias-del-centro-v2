...
const services = [
  {
    ...
    description: "Organizamos remates ferias mensuales con las mejores condiciones del mercado.",
    image: "https://images.unsplash.com/photo-1560013689-95f0c34b7ebb?q=80&w=2070&auto=format&fit=crop",
  },
  {
    icon: <ShoppingCart className="h-8 w-8 text-customAccent" />,
    title: "Compra y Venta Directa",
    description: "Facilitamos operaciones directas entre productores con total transparencia.",
    image: "https://images.unsplash.com/photo-1551651767-d5ffbdd04b83?q=80&w=2070&auto=format&fit=crop",
  },
  {
    icon: <LineChart className="h-8 w-8 text-customAccent" />,
    title: "Asesoramiento",
    description: "Brindamos asesoramiento profesional para optimizar sus operaciones comerciales.",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-700">
            Ofrecemos soluciones integrales para la comercialización de hacienda, adaptadas a las necesidades de cada
            productor.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-customGreen">{service.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              <p className="text-white/80 mb-6">
                Ofrecemos diversas opciones de financiación adaptadas a cada necesidad. Consulte por nuestros planes y
                facilidades de pago.
              </p>
