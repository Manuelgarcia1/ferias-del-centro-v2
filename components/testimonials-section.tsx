      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            La satisfacción de nuestros clientes es nuestro mayor orgullo. Conozca las experiencias de quienes confían
                ...
                <CardContent className="p-8">
                  <div className="flex mb-4">
                    {Array.from({ length: testimonial.rating }).map((_, i) => (
                      <Star key={i} className="h-5 w-5 fill-customAccent text-customAccent" />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-bold text-customGreen">{testimonial.name}</p>
